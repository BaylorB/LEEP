...
/////////////////////////
// DEBUG DEFINITIONS ////               
///////////////////////// *Added to Kev_edit_V1 because LEDs were not working. This didn't fix that. -BB
//#define DEBUG
//#define DEBUG2 
//#define DEBUG3 
//#define DEBUG_TIMING
//#define DEBUG_MONOME
#include <Keypad.h> //*I didn't see where Keypad.h was included. I think we need this for the Arduino to 
...
//*included below for button mapping -BB
...
byte rowToPinNumber[NUM_ROWS] = {5, 4, 3, 2};
byte minRowPinNumber = 2;
byte maxRowPinNumber = 5;
byte colToPinNumbers[NUM_COLS] = {9, 8, 7, 6}; 
byte minColPinNumber = 6;
byte maxColPinNumber = 9;



// MakeyMakey struct for keeping track of input state. **We shouldn't need anything using MakeyMakey -BB
typedef struct
{
  byte pinNumber;
  int keyCode;
...
// colors
uint32_t ledColor = 200; //*played with these numbers to try to get LED output
uint32_t ledColorNone = 0;
uint32_t ledHighlightColor = 150;
